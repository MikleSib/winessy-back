...
class AssetDataIcon implements ValueObjectInterface, DynamicAdminForms\WithFormDefinitionInterface
{
    ...
    {
        return [
            'contract_address' => 'required|string|regex:/^cx[0-9a-f]{40}$/',
    ...
    public static function getFieldsDefinitions(): array
    {
        return [
            ...
            new DynamicAdminForms\ShowInCardFieldDefinition('Min Deposit Amount', 'min_amount', DynamicAdminForms\FormFieldDefinition::ELEMENT_TYPE_INPUT),
        ];
    }
